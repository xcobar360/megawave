<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
    <div class="shop-box">
        ...
        <div class="shop-image entry entry-blog">
			...
			?>
            <?php if($link != ''): ?>			
                <h3 class="entry-title link"><i class="fa fa-link"></i>
                    <a href="<?php echo ( is_single() )? esc_url($link) : esc_url(get_permalink()); ?>">
                        <?php echo esc_html($link); ?><span><?php esc_html__('-', 'gocourier'); ?><?php echo esc_html($title); ?></span>
                    </a>
                </h3>
            <?php endif; ?>
